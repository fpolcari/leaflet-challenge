// creat the tile layers for the backgrounds of the map
...
.then(function(plateData){
    // console loge to make sure the data loads
    console.log(plateData);

    // load date using geoJson and add to the tectonic plates layer group
    L.geoJson(plateData,{
...
// variable to hold the earthquake plates layer
